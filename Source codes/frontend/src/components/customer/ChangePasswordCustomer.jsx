...
const CustomerChangePw = () => {
  ...
  const handleCustomerChangePw = async (e) => {
    e.preventDefault();
    setResponseMessage("");
    setErrorMessage("");
    ...
    try {
      const response = await fetch(
        "http://localhost:8080/api/customer/change-password", //fetch the data from the back end
        {
          method: "PUT",
      ...
      setErrorMessage(error.message || "Something went wrong..."); //handle errors
    }
  };
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-blue-50">
      ...
      <div className="w-full max-w-md bg-white p-6 rounded-lg shadow-lg">
        ...
        <form onSubmit={handleCustomerChangePw} className="space-y-4">
          <div>
            <label
              htmlFor="username"
...
export default CustomerChangePw;
